...
export const getAvailableVersionsHandler: RequestHandler = async (context, request, response) => {
  try {
    ...
    return response.ok({body: {"items":["8.6.0","8.5.0","8.4.2","8.4.1","8.4.0","8.3.3","8.3.2","8.3.1","8.3.0","8.2.3","8.2.2","8.2.1","8.2.0","8.1.3","8.1.2","8.1.1","8.1.0","8.0.1","8.0.0","7.17.6","7.17.5","7.17.4","7.17.3","7.17.2","7.17.1","7.17.0"]}})
